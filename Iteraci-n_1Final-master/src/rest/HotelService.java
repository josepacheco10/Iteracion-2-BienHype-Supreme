...
@Path("operadores/{idOperador: \\d+}/hoteles")
public class HotelService {
	...
	public Response getAll (@PathParam ("idOperador") Long pIDCliente) {
		try {
			...
			List<HotelVO> clientesBD;
			clientesBD = transactManager.getHoteles(pIDCliente);
	...
	@Path( "{idHotel: \\d+}" )
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getById(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHotel" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HotelVO reservaBuscado = tm.getHotel(pIDCliente, id);
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response delete(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHotel" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HotelVO reservaEliminar = tm.getHotel(pIDCliente, id);
			tm.deleteHotel(pIDCliente, id);
