...
@Path("operadores/{idOperador: \\d+}/habitaciones")
public class HabitacionService {
	...
	public Response getAll (@PathParam ("idOperador") Long pIDCliente) {
		try {
			...
			List<HabitacionVO> clientesBD;
			clientesBD = transactManager.getHabitaciones(pIDCliente);
	...
	@Path( "{idHabitacion: \\d+}" )
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getById(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHabitacion" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HabitacionVO reservaBuscado = tm.getHabitacion(pIDCliente, id);
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response delete(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHabitacion" ) Long id )
	{
		try {
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HabitacionVO reservaEliminar = tm.getHabitacion(pIDCliente, id);
			tm.deleteHabitacion(pIDCliente, id);
