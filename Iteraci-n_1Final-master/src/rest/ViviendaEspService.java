...
@Path("operadores/{idOperador: \\d+}/viviendasEsp")
public class ViviendaEspService {
	...
	public Response getAll (@PathParam ("idOperador") Long pIDCliente) {
		try {
			...
			List<ViviendaEsp> clientesBD;
			clientesBD = transactManager.getViviendasEsp(pIDCliente);
	 ...
	 */
	@GET
	@Path( "{idViviendaEsp: \\d+}" )
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getById(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idViviendaEsp" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			ViviendaEsp reservaBuscado = tm.getViviendaEsp(pIDCliente, id);
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response delete(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idViviendaEsp" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			ViviendaEsp reservaEliminar = tm.getViviendaEsp(pIDCliente, id);
			tm.deleteViviendaEsp(pIDCliente, id);
