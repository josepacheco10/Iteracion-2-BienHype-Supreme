...
@Path("operadores/{idOperador: \\d+}/hostales")
public class HostalServices {
	...
	public Response getAll (@PathParam ("idOperador") Long pIDCliente) {
		try {
			...
			List<HostalVO> clientesBD;
			clientesBD = transactManager.getHostales(pIDCliente);
	...
	@Path( "{idHostal: \\d+}" )
	@Produces({ MediaType.APPLICATION_JSON })
	public Response getById(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHostal" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HostalVO reservaBuscado = tm.getHostal(pIDCliente, id);
	...
	@Produces({ MediaType.APPLICATION_JSON })
	public Response delete(@PathParam ("idOperador") Long pIDCliente, @PathParam( "idHostal" ) Long id )
	{
		try{
			AlohAndesTransactionManager tm = new AlohAndesTransactionManager( getPath( ) );
			HostalVO reservaEliminar = tm.getHostal(pIDCliente, id);
			tm.deleteHostal(pIDCliente, id);;
